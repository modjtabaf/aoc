...
bool is_report_safe(const Report& report, int ignore_index=-1)
{
    ...
    for (auto level: report)
    {
        ...
        if (!first)
        {
            ...
            if (diff < min_level || diff > max_level)
            {
                return false;
            }
        }
...
int count_safe_reports(const Reports& reports)
{
    int count = 0;
...
int count_safe_reports_with_dampener(const Reports& reports)
{
    int count = 0;
...
int main()
{
    std::cout << count_safe_reports(sample_reports) << std::endl;
    std::cout << count_safe_reports(reports) << std::endl;
    std::cout << count_safe_reports_with_dampener(sample_reports) << std::endl;
    std::cout << count_safe_reports_with_dampener(reports) << std::endl;
    return 0;
}
